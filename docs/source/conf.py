...
if on_ci:
    ...
    subprocess.call(
        "cd ../.. && cmake . %s %s && make -j2" % (cmake_defs, cmake_py_ver), shell=True
    )
...
# html_theme = "classic"
html_theme_path = [sphinx_rtd_theme.get_html_theme_path(), "mytheme", "."]
...
breathe_projects = {"opengm": "../xml/"}


exhale_args = {
    # These arguments are required
    "containmentFolder": "./api",
    "rootFileName": "opengm_api.rst",
    "rootFileTitle": "opengm API",
...
breathe_default_project = "opengm"
