...
============
    ...
    * Continous Integration:
        * `azure-pipelines <https://dev.azure.com/DerThorsten/opengm/_build/latest?definitionId=1&branchName=master>`_
        * `circle-ci <https://circleci.com/gh/DerThorsten/opengm/tree/master>`_
        * `travis-ci <https://travis-ci.org/DerThorsten/opengm>`_
    * bumpversion for version handling
    * Documentation with sphinx breathe and on
      `readthedocs <http://opengm.readthedocs.io/en/latest/?badge=latest>`_
